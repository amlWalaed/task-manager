...
<template>
   <div :style="{
      ...
      <FloatingLabel v-if="!!props?.floatingLabel"
                     :for="field.id"
                     :value="floatingLabel"
      ...
      <slot name="endIcon"
            classes="absolute inset-y-0 end-0 grid place-content-center px-[var(--icon-padding)]">
...
<style scoped>input[type="number"]::-webkit-outer-spin-button,
